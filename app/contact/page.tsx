    ...
    <main className="section dark-section">
      <div className="container two-col">
        <div>
          ...
          <h1 style={{ marginTop: 14 }}>Let's talk about your surface transformation!</h1>
          <p className="lead" style={{ marginTop: 18 }}>
            From countertop resurfacing and custom epoxy counters to decorative floors and garages or outdoor living surfaces, 
            Inland Pacific Coatings is built to help clients create spaces that look elevated and perform beautifully.
            Tell us about your countertop, floor, garage, or outdoor-surface project.
          </p>
          <p>
            <strong style={{ color: "var(--gold-soft)" }}>Phone:</strong> 208.714.1951
          </p>
          <p>
            <strong style={{ color: "var(--gold-soft)" }}>Email:</strong> kevin@ipcepoxy.com
          </p>
          <p>
            <strong style={{ color: "var(--gold-soft)" }}>Service Area:</strong> Coeur d&apos;Alene, Spokane, and surrounding Inland Northwest communities
          </p>
        </div>
